...
aiptag.settings = {
	sVersion: '7.0',
	sUpdated: 'Thursday 25 April 2024 - 08:54',
	sUpdatedShort: '25/04/24 08:54',
	sUpdateID: '6629fe16847cd',
	sPubName: 'MNS',
	sSellerId: 'MNS',
	sPubUrl: 'agariotime.com',
	sAdUnitVideo: 'agariotime.com_preroll',
	sAdBreakChannel: '',
...
function aipAPI() {
	...
	if(aiptag.settings.sAdUnitVideo) {
		...
		this.videoAdUnit["agariotime.com_preroll"] = {
code: 'prerollUnit',
ortb2Imp: {
	ext: {
		gpid: 'prerollUnit',
	...
	},
	{
...
};this.videoAdUnitMaxDuration["agariotime.com_preroll"] = "30000";this.videoAdUnitSkipButtonTimeout["agariotime.com_preroll"] = false;	}

			this.adUnits['agariotime-com_300x250'] = [{
		code: 'agariotime-com_300x250',
		ortb2Imp: {
			ext: {
				gpid: 'agariotime-com_300x250',
				data: {
					pbadslot: 'agariotime-com_300x250'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					...
					ext: { placement_name: 'agariotime.com_300x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '14361658'
				}
			}
		]
	}];
		this.adSlots['agariotime-com_300x250'] = {adunit: 'agariotime.com_300x250', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['agariotime-com_300x250'] = [{slotID: 'agariotime-com_300x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/agariotime.com_300x250', sizes: [[300, 250]]}];
		}
		this.requestManager['agariotime-com_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('agariotime-com_300x250', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['agariotime-com_300x250'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['agariotime-com_300x250'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['agariotime-com_300x250'].autoRefreshHasFocus+" for: "+this.adSlots['agariotime-com_300x250'].adunit);
			} catch(e){}
			*/
					this.adUnits['agariotime-com_300x250_2'] = [{
		code: 'agariotime-com_300x250_2',
		ortb2Imp: {
			ext: {
				gpid: 'agariotime-com_300x250_2',
				data: {
					pbadslot: 'agariotime-com_300x250_2'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'agariotime.com_300x250_2'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '14361661'
				}
			}
		]
	}];
		this.adSlots['agariotime-com_300x250_2'] = {adunit: 'agariotime.com_300x250_2', sizes: [300, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['agariotime-com_300x250_2'] = [{slotID: 'agariotime-com_300x250_2', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/agariotime.com_300x250_2', sizes: [[300, 250]]}];
		}
		this.requestManager['agariotime-com_300x250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('agariotime-com_300x250_2', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['agariotime-com_300x250_2'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['agariotime-com_300x250_2'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['agariotime-com_300x250_2'].autoRefreshHasFocus+" for: "+this.adSlots['agariotime-com_300x250_2'].adunit);
			} catch(e){}
			*/
					this.adUnits['agariotime-com_250x250'] = [{
		code: 'agariotime-com_250x250',
		ortb2Imp: {
			ext: {
				gpid: 'agariotime-com_250x250',
				data: {
					pbadslot: 'agariotime-com_250x250'
				}
			}
		},
		mediaTypes: {
		...
		bids: [
			...
			},
			{
				...
				params: {
					pubId: '7683ebe7bee7969',
					ext: { placement_name: 'agariotime.com_250x250'}
				}
			},
			{
				bidder: 'appnexus',
				params: {
					placementId: '14361662'
				}
			}
		]
	}];
		this.adSlots['agariotime-com_250x250'] = {adunit: 'agariotime.com_250x250', sizes: [250, 250], reload: true, autoRefresh: true, autoRefreshTimer: aiptag.settings.iAutoRefreshTimer, autoRefreshPercentage: aiptag.settings.iAutoRefreshPercentage, autoRefreshHasFocus: true, fallback: false};
		if(aiptag.settings.iAmazonDisplayAds) {
			this.adUnitsAps['agariotime-com_250x250'] = [{slotID: 'agariotime-com_250x250', slotName: '/'+aiptag.settings.sNetworkIdDisplay+'/agariotime.com_250x250', sizes: [[250, 250]]}];
		}
		this.requestManager['agariotime-com_250x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		try{
			if(aiptag.settings.iDisableAdWhenNotInTheActiveView === true) {
				this.observeTarget('agariotime-com_250x250', true);
			}
		} catch(e){}

					/*
			try{
				this.log("AD auto refresh enabled every "+this.adSlots['agariotime-com_250x250'].autoRefreshTimer/1000+" seconds, when "+this.adSlots['agariotime-com_250x250'].autoRefreshPercentage+"% inview and the windows focus is "+this.adSlots['agariotime-com_250x250'].autoRefreshHasFocus+" for: "+this.adSlots['agariotime-com_250x250'].adunit);
			} catch(e){}
			*/
...
aipAPI.prototype.checkBidders = function() {
	...
	if(aRemoveBidders.length > 0) {
		//removeBidders from display
					this.removeBidders(this.adUnits['agariotime-com_300x250'], aRemoveBidders);
					this.removeBidders(this.adUnits['agariotime-com_300x250_2'], aRemoveBidders);
					this.removeBidders(this.adUnits['agariotime-com_250x250'], aRemoveBidders);
		
		//removeBidders from preroll
						this.removeBidders([this.videoAdUnit["agariotime.com_preroll"]], aRemoveBidders);
					}
}
...
aipAPI.prototype.sendStats = function() {
	...
	try {
		...
		if (!window.location.href.includes("adinplay.com")) {
			var data = JSON.stringify({"jspath":"api.adinplay.com/libs/aiptag/pub/MNS/agariotime.com/tag.min.js"});
	...
	try {
		...
		rawFile.onreadystatechange = function() {
			if (rawFile.readyState === 4) {
				...
				var aip_id = "MNS/agariotime.com";
				var seller_id_js = "MNS";
				var mcm_js = "";
